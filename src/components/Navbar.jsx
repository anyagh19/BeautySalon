                ...
                <Menu setActive={setActive}>
                    ...
                    <MenuItem setActive={setActive} active={active} item="Home">
                        <div className="flex flex-col space-y-4 text-sm">
                            <HoveredLink href="/home">HAIR SALON</HoveredLink>
                            <HoveredLink href="/interface-design">CALENDER</HoveredLink>
                            <HoveredLink href="/">BEAUTY SALON</HoveredLink>
                            <HoveredLink href="https://nelson.themerex.net/" target="_blank" rel="noopener noreferrer">
                                BARBERSHOP VIDEO
                            </HoveredLink>

                            <HoveredLink href="https://nails.nelson.themerex.net/" target="_blank" rel="noopener noreferrer">
                        NAILS ARTIST
                            </HoveredLink>
